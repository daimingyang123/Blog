...
public class ReplyDAOimpl extends HibernateDaoSupport {
	...
	public static final String REPLY_FILENAME = "replyFilename";
	...
	public Reply findById(java.lang.Integer id) {
		...
		try {
			Reply instance = (Reply) getHibernateTemplate().get("entity.Reply",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByReplyUserName(Object replyUserName) {
		return findByProperty(REPLY_USER_NAME, replyUserName);
	}

	public List findByReplyFilename(Object replyFilename) {
		return findByProperty(REPLY_FILENAME, replyFilename);
	}
